...
public class UserStorageProviderTest {
	...
	public void beforeMethod() {
		...
		UserStorageProvider.onlyForTestSetUserStorageViewInstanceProvider(null);
	}
	...
	public void testGetRecordStorageIsSynchronized_toPreventProblemsWithFindingImplementations()
			throws Exception {
		Method getStorageView = UserStorageProvider.class.getMethod("getStorageView");
	...
	public void testOnlyForTestSetAppTokenStorageViewInstanceProvider() throws Exception {
		...
		UserStorageProvider.onlyForTestSetUserStorageViewInstanceProvider(instanceProviderSpy2);
